...
/**
 * Plugin implementation of the 'media_file_link' formatter.
 *
 * @FieldFormatter(
 *   id = "media_file_link",
 ...
 * )
 */
class MediaFileLinkFormatter extends EntityReferenceFormatterBase implements ContainerFactoryPluginInterface {
  /**
   * The ICCWC manager.
   *
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($this->getEntitiesToView($items, $langcode) as $delta => $entity) {
      ...
      $langcode = $entity->get('field_language')->value;
